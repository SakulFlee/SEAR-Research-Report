...
When loading a new \textit{dependency} we call it \textit{Planned Dependency-Injection} or \textit{Wanted Dependency-Injection}.
...
From now on we will use the term \underline{plugin} in context of a \textit{Planned Dependency-Injection}.
...
To be a 100\% protected from this one would have to write \textbf{everything}, including compilers, libraries, programs, etc., themselves and restrict access to \underline{only them}.
