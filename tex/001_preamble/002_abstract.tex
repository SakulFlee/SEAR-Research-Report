...
This research report will evaluate rather, enabling Dependency-Injection in Java comes with high risk and poses a high threat to the application, or, if implementing it properly is worth the risk, comes with benefits and if it is possible to prevent unwanted injections and scenarios to happen.
