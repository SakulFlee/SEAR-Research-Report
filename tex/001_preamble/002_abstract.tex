...
In summary, we found out that dependency-injection is indeed possible and, without further securing an application, can pose a high risk not only to the application, but also the system and user.
