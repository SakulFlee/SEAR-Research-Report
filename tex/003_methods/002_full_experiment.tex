...
With the previous section the plugin system, with the \texttt{agent}/\lstinline{instrumentation}, is defined and a plugin exists, is loaded and the task-method was invoked.
