...
From the JavaDoc:
\begin{quote}
    [The package] Provides services that allow Java programming language agents to instrument programs running on the JVM\footnote{Java-Virtual-Machine}.\newline
    The mechanism for instrumentation is modification of the byte-codes of methods.
\end{quote}\parencite{javadoc:instrument}\\\clearpage
