...
The following overall positive benefits and contrary negative impacts can be observed:
\begin{center}
    \begin{tabular}{|p{5cm}|p{5cm}|}
        ...
        \begin{itemize}
            \item Easy to extend
            \item Separation of code bases
            \item Design decision to enable \textit{plugins}/\textit{mods}
            \item Configurability\footnote{User can decide what to install}
        \end{itemize} &
        \begin{itemize}
            \item Easy to exploit
            \item Implementing a \textit{Plugin-System} makes an application vulnerable
