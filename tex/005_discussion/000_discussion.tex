\labeledsection{Discussion}
The previous sections focused on a \textit{plugin-system} /\\ \underline{planned dependency-injection}.
...
\input{tex/005_discussion/001_improve_security.tex}